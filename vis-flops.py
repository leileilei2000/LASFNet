...
if __name__ == '__main__':
    ...
    model = YOLO(r'runs/LLVIP/weights/best.pt').model # select your model.pt path
    ...
    total_flops, total_params, layers = profile(model, [input1,input2], verbose=True, ret_layer_info=True)
