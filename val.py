...
def run(
    ...
    if training:  # called by train.py
        ...
        import thop
        input_image_size = opt.imgsz
        input_image = torch.randn(1, 3, input_image_size, input_image_size).to(device)
        flops, params = thop.profile(model, inputs=(input_image,input_image), verbose=False)
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default="runs/train/LLVIP/weights/best.pt", help="model path(s)")
